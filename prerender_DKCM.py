    ...
    for _, (
        ...
        for other_agent_id in unique_agent_ids:
            ...
            for timestamp, (coord, valid_coordinate, past_yaw,) in enumerate(
                ...
                box_points = box_points @ np.array(
                    (
        ...
        raster_dict = {
            ...
            "current_velocity_yaw": current_velocity_yaw,
            "current_length": lengths,
            "future_heading": future_yaw,
            "future_speed": future_speed,
            "future_velocity_yaw": future_velocity_yaw,
            "yaw": yaw,
...
def merge(
    ...
    raster_data = rasterize(
        ...
        parsed["state/future/bbox_yaw"].numpy(),
        parsed["state/future/vel_yaw"].numpy(),
        parsed["state/future/speed"].numpy(),
    ...
    for i in range(len(raster_data)):
        ...
        r = np.random.randint(max_rand_int, dtype=np.int64)  # fix dtype
